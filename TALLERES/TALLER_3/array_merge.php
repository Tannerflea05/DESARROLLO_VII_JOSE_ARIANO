...
$misComidas = ["Ham", "Ice cream", "Ramen"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["Salchipapa", "Arroz frito", "Pollo frito con soda de uva"]; // Reemplaza con las comidas favoritas de tu amigo
