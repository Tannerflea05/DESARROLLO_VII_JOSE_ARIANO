...
$miArray = ["Crusader","Highway Man","Man At Arms", "Grave Robber"]; // Reemplaza esto con tu propio array
$miString = "Vestal474"; // Reemplaza esto con tu propio string
$miNumero = 87; // Reemplaza esto con tu propio número
