...
$paises = ["Japon","Korea del sul","Alemania","Croacia","Canada"]; // Reemplaza esto con tu array de países
$listaPaises = implode("-", $paises);
$paises2 = ["Japon","Korea del sul","Alemania","Croacia","Canada"];
$listaPaises2 = implode("**", $paises);

echo "</br>Mi lista de países para visitar: $listaPaises</br>";

echo "</br>Mi lista de países para visitar: $listaPaises2</br>";
