...
$misPeliculas = "The batman - Heaven's field - Watering with you - Watchmen - V"; // Reemplaza esto con tu lista de películas
...
echo "</br> Array 2 de peliculas</br>";
$misPeliculas2 = "The batman - Heaven's field - Watering with you - Watchmen - V"; // Reemplaza esto con tu lista de películas
$arrayPeliculas2 = explode("-", $misPeliculas2,2);
print_r($arrayPeliculas2);
