...
$misCanciones = ["Extras","Brave Ocean","Inertia","Don't","Aerials"]; // Reemplaza esto con tu array de canciones
...
$infocancion = implode(" | ", $cancion);

Echo "Info en variable cancion $infocancion";

$numcancion = count($cancion);
echo "</br> Numero de elementos en cancion = $numcancion";
